...
//            message = INVALID_URI)
    ...
    public @Size(max = 5, message = UrlMessages.INVALID_SHORT_URI_SIZE) @Pattern(regexp = "^[\\w_-]+$", message = UrlMessages.INVALID_SHORT_URI_PATTERN) String getShortUri() {
        return this.shortUri;
    }

    public @NotBlank(message = UrlMessages.NO_URI) @Pattern(regexp = "\\b(https?|ftp|file)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]",
            message = UrlMessages.INVALID_URI) String getUri() {
        return this.uri;
    }
    ...
    public void setShortUri(@Size(max = 5, message = UrlMessages.INVALID_SHORT_URI_SIZE) @Pattern(regexp = "^[\\w_-]+$", message = UrlMessages.INVALID_SHORT_URI_PATTERN) String shortUri) {
        this.shortUri = shortUri;
    }

    public void setUri(@NotBlank(message = UrlMessages.NO_URI) @Pattern(regexp = "\\b(https?|ftp|file)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]",
            message = UrlMessages.INVALID_URI) String uri) {
        this.uri = uri;
    }
